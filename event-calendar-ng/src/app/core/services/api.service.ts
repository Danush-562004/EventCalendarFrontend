...
export class NotificationApiService {
  ...
  markRead(id: number): Observable<object> {
    return unwrap(this.http.put<ApiResponse<object>>(`${BASE}/notifications/${id}/read`, {}));
  }

  markAllRead(): Observable<object> {
    return unwrap(this.http.put<ApiResponse<object>>(`${BASE}/notifications/read-all`, {}));
  }
}
